 ...
 */
class getDataFeatured() : AsyncTask<Void, Void, String>() {


    var context: Context? = null
    var url: String? = null
    var urlConnection: String? = null

    constructor(context: Context, url: String, urlConnection : String) : this() {
...
//                val url = "http://eniso.info/ws/login/toto?password=toto1243"
    ...
    override fun onPostExecute(result: String?) {
        ...
        if (hasInternet) {
            try {
                getDataLoginFromApi(context!!,urlConnection!!).execute()
